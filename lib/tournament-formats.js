...
const TOURNAMENT_FORMATS = {
  ...
  texas_scramble: {
    key: 'texas_scramble', label: '2-manns Scramble', leaderboardMode: 'strokes_asc', participantMode: 'team', teamSize: 2,
  ...
  texas_scramble_4: {
    key: 'texas_scramble_4', label: 'Texas Scramble', leaderboardMode: 'strokes_asc', participantMode: 'team', teamSize: 4,
    adminSections: [ADMIN_SECTIONS.TOURNAMENT_INFO, ADMIN_SECTIONS.TEAMS, ADMIN_SECTIONS.COURSE_AND_HOLES, ADMIN_SECTIONS.GAMEDAY, ADMIN_SECTIONS.SPONSORS, ADMIN_SECTIONS.CONTROL_PANEL],
  ...
  greensome: {
    ...
    adminSections: [ADMIN_SECTIONS.TOURNAMENT_INFO, ADMIN_SECTIONS.PAIR_SETUP, ADMIN_SECTIONS.MATCHES],
  ...
  matchplay: {
    key: 'matchplay', label: 'Matchspill', leaderboardMode: 'matchplay_status', participantMode: 'match', teamSize: 2,
    adminSections: [ADMIN_SECTIONS.PLAYERS, ADMIN_SECTIONS.PAIR_SETUP, ADMIN_SECTIONS.MATCHES],
    handicap: { method: 'percentage', handicapPercentage: 100 }
  },
  ryder_cup: {
...
const LEGACY_FORMAT_MAP = {
  ...
  'texas scramble': 'texas_scramble_4',
...
function validateTeamSizeForFormat(format, count) {
  const required = getFormatDefinition(format).teamSize;
